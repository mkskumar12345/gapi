...
const { addGrievance, show_no_of_grievances, show_all_grievances, grievances_by_type, view_grievance_by_id} = require('../controllers/grievanceCont');
...
grievanceRoute.route('/show/number/grievance').get(user_tokenval,show_no_of_grievances)
